...
def main():
    while True:
        ...
        #scan_list is an array of 10 status readings (at 18 degree increments each) with values of 2 (greater than ref distance), 1 (if between 10 and ref), or 0 (if lower than ref)
